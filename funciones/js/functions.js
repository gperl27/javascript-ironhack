...
array_lengths.push(findLongestWord(["Chocolate", "Vanilla", "Strawberry", "Coconut"]));
array_lengths.push(findLongestWord(["Baseball", "Football", "Hockey", "Basketball", "Soccer"]));
...
function arrangeElements( array )
{
	...
	array.sort(function(a,b){
		...
		// can also use typeof a === 'number' here
		if(typeof a !== 'string'){
			return -1;
		}
	});
